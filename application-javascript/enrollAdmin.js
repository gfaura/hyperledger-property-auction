...
const { buildCCPOrg1, buildCCPOrg2, buildCCPOrg3, buildWallet }= require('./AppUtil.js');// require('../../test-application/javascript/AppUtil.js');

const mspOrg3 = 'Org3MSP'; // GF: Adding PropertyRegister
...
//********************************************************************* 
// GF: Adding the PropertyRegister organisation
async function connectToOrg3CA() {
    console.log('\n--> Enrolling the PropertyRegister new user');
...
async function main() {
    ...
    if (org == 'Org1' || org == 'org1') {
       ...
       else if (org == 'Org3' || org == 'org3') { //GF Adding the PropertyRegister organisation
        await connectToOrg3CA();
       } else {
         console.log("Usage: node enrollAdmin.js org userID");
